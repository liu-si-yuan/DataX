package com.alibaba.datax.plugin.reader.esgyndbreader;
...
/**
 * @program: esgyndbreader
 * @description: from esgyndb to DataX
 * @create: 2019-09-17 17:24
 */
public class EsgyndbReader extends Reader {
